 ...
 * }}
 */
export const filtersValidators = {
  array: (filtersObject, value) => {
    ...
    for (const key in filtersObject) {
      ...
      validators.array[key](value, filtersObject[key])
    }

    return true
  },
  number: (filtersObject, value) => {
    ...
    for (const key in filtersObject) {
      ...
      validators.number[key](value, filtersObject[key])
    }

    return true
  },
  string: (filtersObject, value) => {
    ...
    for (const key in filtersObject) {
      ...
      validators.string[key](value, filtersObject[key])
    }
