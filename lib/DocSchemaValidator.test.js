...
describe('DocSchemaValidator - Filters', () => {
  ...
  describe('in @typedef', () => {
    ...
    test('variant 3 - union of 2 typedefs in one main typedef', () => {
      const [ , , ast ] = parser.parseComments(`
        /** @typedef {boolean} BooleanTypedef */

        /** @typedef {string} StringTypedef */

        /**
         * @typedef {object} MainType
         * @property {BooleanTypedef | StringTypedef} union
         */
        `)
      ...
      ).toMatchObject({ pass: true, valuePath: ['union'] })
