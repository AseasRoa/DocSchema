...
describe('Parsers', () => {
        ...
        expect(parser(wrappedPrimitive))
          .toStrictEqual({
            ...
            typeExpression: wrappedPrimitive
              .replaceAll(/[ \(\)]/gu, '') // Remove the added stuff
          })
      })
  ...
  describe('Complex Types', () => {
    test('should parse array types', () => {
      ...
      /*
       * Kinda wrong type.
       * It seems that JsDoc doesn't support & union,
       * so it should be parsed as | union.
       */
      expect(parse('Array<number & string>')[0])
        .toStrictEqual(
          {
    ...
    test('should parse array2 types', () => {
      /*
       * Lower case type
       */
       ...
       * The & union is not in JsDoc,
       * but it should work as | here
       */
    ...
    test('should parse typedef types', () => {
      let expression = ''
